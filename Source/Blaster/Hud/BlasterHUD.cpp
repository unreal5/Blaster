...
void ABlasterHUD::DrawHUD()
{
	...
	if (GEngine)
	{
		...
		DrawCrosshair(HUDPackage.CrosshairLeft, ViewportCenter, FVector2D{-SpreadScaled, 0.0f});
		DrawCrosshair(HUDPackage.CrosshairRight, ViewportCenter, FVector2D{SpreadScaled, 0.0f});
		DrawCrosshair(HUDPackage.CrosshairTop, ViewportCenter, FVector2D{0.0f, -SpreadScaled});
		DrawCrosshair(HUDPackage.CrosshairBottom, ViewportCenter, FVector2D{0.0f, SpreadScaled});
	}
}
